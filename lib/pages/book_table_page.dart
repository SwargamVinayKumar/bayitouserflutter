            ...
            child: Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
              child: Column(
                ...
                children: [
                  ...
                  SectionTitleItem(title: "Select Date"),
                  ...
                  const SizedBox(height: 24),
                  SectionTitleItem(title: "Select Time Slot (1 Hour)"),
                  ...
                  const SizedBox(height: 24),
                  SectionTitleItem(title: "Number of People"),
                  ...
                  const SizedBox(height: 24),
                  SectionTitleItem(title: "Select Seating Layout"),
                  const SizedBox(height: 16),
                  Row(
                    mainAxisAlignment:
