...
class ApiProvider<T> extends GetConnect {
  ...
  // String apiLiveBaseUrl = 'https://192.168.29.4:3055/user/';
  String token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJtb2JpbGUiOjk0OTI0NTQ4NDMsImlkIjoiNmE4NjdmM2NhNDdjMWY0MTZjNDViZTE1IiwiaWF0IjoxNzg3MTk5MjkyLCJleHAiOjE3OTQ5NzUyOTJ9.wszE7LTLmJShNDBoUz8QXX0O-C3JznK9tb7hgZgGtwk';
