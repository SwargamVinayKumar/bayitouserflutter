...
mixin _$BookingRequestModel {
  ...
  List<Map<String, dynamic>>? get guestDetailsList =>
...
class _$BookingRequestModelImpl implements _BookingRequestModel {
  const _$BookingRequestModelImpl(
      ...
      this.paymentType,
      this.bookingType,
      final List<Map<String, dynamic>>? guestDetailsList,
      this.couponId,
  ...
  final List<Map<String, dynamic>>? _guestDetailsList;
  @override
  List<Map<String, dynamic>>? get guestDetailsList {
...
abstract class _BookingRequestModel implements BookingRequestModel {
  const factory _BookingRequestModel(
      ...
      final Map<String, dynamic>? paymentDetails,
      final String? orderId,
      final String? paymentId}) = _$BookingRequestModelImpl;
