...
abstract class $ValidateVersionRequestModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? version, LocationModel? location});
...
class _$ValidateVersionRequestModelImpl
  ...
  const _$ValidateVersionRequestModelImpl(
      {required this.version, required this.location});
  ...
  @override
  String toString() {
    return 'ValidateVersionRequestModel(version: $version, location: $location)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, version, location);
...
abstract class _ValidateVersionRequestModel
  ...
  const factory _ValidateVersionRequestModel(
...
class _$PaginationRequestModelImpl implements _PaginationRequestModel {
  ...
  @override
  String toString() {
    return 'PaginationRequestModel(query: $query, unitId: $unitId, searchQuery: $searchQuery, type: $type, docId: $docId, homeId: $homeId, pgId: $pgId, latitude: $latitude, longitude: $longitude, page: $page, filterRequest: $filterRequest, sort: $sort)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, query, unitId, searchQuery, type,
      docId, homeId, pgId, latitude, longitude, page, filterRequest, sort);
...
mixin _$FilterRequestModel {
  ...
  List<String>? get homeTypes => throw _privateConstructorUsedError;
...
class _$FilterRequestModelImpl implements _FilterRequestModel {
  ...
  @override
  String toString() {
    return 'FilterRequestModel(locations: $locations, homeTypes: $homeTypes, unitTypes: $unitTypes, bookingType: $bookingType, startPrice: $startPrice, endPrice: $endPrice)';
  }
